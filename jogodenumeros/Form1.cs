...
namespace jogodenumeros
{
    public partial class frmJogodeNumeros : Form
    {
        ...
        private void frmJogodeNumeros_Load(object sender, EventArgs e)
        {
            ...
            randomNumber = random.Next(1, 101); //Número aleatório de 1 até 100.
        }

        private void btnTentivas_Click(object sender, EventArgs e)
        {
            {//Verifica se o número de tentativas chegou até 0.
                ...
                //Validação de valor do palpite (entre 1 e 100)
